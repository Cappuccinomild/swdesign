    ...
    if($data[0] == 'customer'){
      ...
      <table style='margin-bottom: -15px;'>
        <tr>
          ...
          <td><input type='text' id='DesignerID' name='DesignerID' value='".$DesignerID."'
      ...
      <table style='margin-bottom: -15px;'>
        <tr>
          <td style='text-align:left;'><label for='CustomerID' id='msg-table-text'> 소비자 ID</td>
          <td><input type='text' id='CustomerID' name='CustomerID'
          maxlength='13' size='30'  value='".$CustomerID."'/></td>
        </tr>
        <tr>
          <td style='text-align:left;'><label for='Title' id='msg-table-text'>제목</label></td>
          <td><input type='text' id='Title' name='Title'maxlength='40' size='30'/></td>
